 ...
 */
@Entity
public class RequisicaoEquivalencia implements Serializable {
    ...
    public RequisicaoEquivalencia(String AlunoRa, Disciplina diciplinaRequerida, StatusSolicitacao status) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RequisicaoEquivalencia)) {
            return false;
        }
        RequisicaoEquivalencia other = (RequisicaoEquivalencia) object;
